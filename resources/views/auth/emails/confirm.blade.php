            ...
            <div class="column"
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                    ...
                    <p class="size-14" style="Margin-top: 16px;Margin-bottom: 20px;font-size: 14px;line-height: 21px;"
                       lang="x-size-14">Welcome to Foookat. Thanks for signing up. Please click the below button to
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                    <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                        <![if !mso]><a
                                ...
                                href="{{ route('signup.confirm', $user->email_verification_code)}}">Activate Your
                            Account</a><![endif]>
                        <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                     href="{{ route('signup.confirm', $user->email_verification_code)}}"
                                     style="width:236px"
